...
public class AsyncService {
	...
	public CompletableFuture<EmployeeNames> getEmployeeName() throws InterruptedException 
	{
		...
		EmployeeNames employeeNameData = restTemplate.getForObject("http://192.168.99.100:8085/names", EmployeeNames.class);
	...
	public CompletableFuture<EmployeeAddresses> getEmployeeAddress() throws InterruptedException 
	{
		...
		EmployeeAddresses employeeAddressData = restTemplate.getForObject("http://192.168.99.100:8085/addresses", EmployeeAddresses.class);
	...
	public CompletableFuture<EmployeePhone> getEmployeePhone() throws InterruptedException 
	{
		...
		EmployeePhone employeePhoneData = restTemplate.getForObject("http://192.168.99.100:8085/phones", EmployeePhone.class);
